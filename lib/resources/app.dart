...
// this module is optional, since we already specify the Firebase Options in the google-services.json, so we can just use <Firebase Plugin>.instance
...
class App
{
  ...
  static final FirebaseApp app = FirebaseApp.instance;

  // optional
  static Future<void> instantiateFirebaseApp() async {
